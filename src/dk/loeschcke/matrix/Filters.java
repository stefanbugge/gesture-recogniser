...
public class Filters extends JFrame
{
	...
	public Filters()
	{
		...
		buttonScale.addActionListener(buttonHandler);
	...
	private void loadImage(){
		image = MarvinImageIO.loadImage("./res/arara2.jpg");
	...
	private class ButtonHandler implements ActionListener
	{
		public void actionPerformed(ActionEvent a_event){
			...
			if(a_event.getSource() == buttonGray){
			...
			else if(a_event.getSource() == buttonScale){
				...
				imagePlugin.setAttribute("newHeight", 200);	
				MarvinImage clone = image.clone();
				imagePlugin.process(image, clone);
				image = clone;
			}
			image.update();
			imagePanel.setImage(image);
